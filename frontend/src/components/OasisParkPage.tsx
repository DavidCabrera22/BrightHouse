...
const amenidades = [
  ...
  { icon: 'laptop_mac', label: 'Coworking' },
  { icon: 'celebration', label: 'Salón de eventos' },
  { icon: 'child_care', label: 'Parque infantil' },
  { icon: 'music_note', label: 'Guardería / Play & Music' },
  { icon: 'fitness_center', label: 'Gimnasio cubierto' },
  { icon: 'self_improvement', label: 'Spa' },
  { icon: 'pets', label: 'Spa de mascotas' },
  { icon: 'sports_basketball', label: 'Sport Center' },
  { icon: 'flight', label: 'Helipuerto' },
  { icon: 'security', label: 'Vigilancia 24/7' },
  { icon: 'elevator', label: '2 Ascensores' },
  { icon: 'bolt', label: 'Planta eléctrica' },
  { icon: 'local_parking', label: 'Parqueaderos comunales' },
  { icon: 'wb_sunny', label: 'Solárium' },
];
